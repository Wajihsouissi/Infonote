...
export const iconRegistry: IconData[] = [
    // General
    { name: 'Document', iconName: 'FileText', category: 'General', color: 'var(--text-faint)' },
    { name: 'Folder', iconName: 'Folder', category: 'General', color: 'var(--text-faint)' },
    { name: 'File', iconName: 'File', category: 'General', color: 'var(--text-faint)' },
    { name: 'Search', iconName: 'Search', category: 'General', color: 'var(--text-faint)' },
    { name: 'Home', iconName: 'Home', category: 'General', color: 'var(--text-faint)' },
    { name: 'Settings', iconName: 'Settings', category: 'General', color: 'var(--text-faint)' },
    { name: 'User', iconName: 'User', category: 'General', color: 'var(--text-faint)' },
    { name: 'Users', iconName: 'Users', category: 'General', color: 'var(--text-faint)' },
    { name: 'Book', iconName: 'Book', category: 'General', color: 'var(--text-faint)' },
    { name: 'Book Open', iconName: 'BookOpen', category: 'General', color: 'var(--text-faint)' },
    { name: 'Clock', iconName: 'Clock', category: 'General', color: 'var(--text-faint)' },
    { name: 'Calendar', iconName: 'Calendar', category: 'General', color: 'var(--text-faint)' },
    { name: 'Save', iconName: 'Save', category: 'General', color: 'var(--text-faint)' },
    { name: 'Trash', iconName: 'Trash', category: 'General', color: 'var(--text-faint)' },
    { name: 'Trash2', iconName: 'Trash2', category: 'General', color: 'var(--text-faint)' },
    { name: 'Edit', iconName: 'Edit', category: 'General', color: 'var(--text-faint)' },
    { name: 'Copy', iconName: 'Copy', category: 'General', color: 'var(--text-faint)' },
    { name: 'Clipboard', iconName: 'Clipboard', category: 'General', color: 'var(--text-faint)' },
    { name: 'List', iconName: 'ClipboardList', category: 'General', color: 'var(--text-faint)' },
    { name: 'Share', iconName: 'Share', category: 'General', color: 'var(--text-faint)' },
    { name: 'Share2', iconName: 'Share2', category: 'General', color: 'var(--text-faint)' },
    { name: 'Download', iconName: 'Download', category: 'General', color: 'var(--text-faint)' },
    { name: 'Upload', iconName: 'Upload', category: 'General', color: 'var(--text-faint)' },
    { name: 'Menu', iconName: 'Menu', category: 'General', color: 'var(--text-faint)' },
    { name: 'Filter', iconName: 'Filter', category: 'General', color: 'var(--text-faint)' },
    { name: 'Eye', iconName: 'Eye', category: 'General', color: 'var(--text-faint)' },
    { name: 'Eye Off', iconName: 'EyeOff', category: 'General', color: 'var(--text-faint)' },
    { name: 'Lock', iconName: 'Lock', category: 'General', color: 'var(--text-faint)' },
    { name: 'Unlock', iconName: 'Unlock', category: 'General', color: 'var(--text-faint)' },
    { name: 'Key', iconName: 'Key', category: 'General', color: 'var(--text-faint)' },
    { name: 'Shield', iconName: 'Shield', category: 'General', color: 'var(--text-faint)' },
    { name: 'Link', iconName: 'Link', category: 'General', color: 'var(--text-faint)' },
    { name: 'External Link', iconName: 'ExternalLink', category: 'General', color: 'var(--text-faint)' },
    { name: 'Attachment', iconName: 'Paperclip', category: 'General', color: 'var(--text-faint)' },
    { name: 'Hash', iconName: 'Hash', category: 'General', color: 'var(--text-faint)' },
    { name: 'History', iconName: 'History', category: 'General', color: 'var(--text-faint)' },
    { name: 'Bookmark', iconName: 'Bookmark', category: 'General', color: 'var(--text-faint)' },
    { name: 'More (H)', iconName: 'MoreHorizontal', category: 'General', color: 'var(--text-faint)' },
    { name: 'More (V)', iconName: 'MoreVertical', category: 'General', color: 'var(--text-faint)' },
    ...
    { name: 'Up', iconName: 'ArrowUp', category: 'Status', color: 'var(--text-faint)' },
    { name: 'Down', iconName: 'ArrowDown', category: 'Status', color: 'var(--text-faint)' },
    { name: 'Left', iconName: 'ArrowLeft', category: 'Status', color: 'var(--text-faint)' },
    { name: 'Right', iconName: 'ArrowRight', category: 'Status', color: 'var(--text-faint)' },
    { name: 'Chevron Up', iconName: 'ChevronUp', category: 'Status', color: 'var(--text-faint)' },
    { name: 'Chevron Down', iconName: 'ChevronDown', category: 'Status', color: 'var(--text-faint)' },
    { name: 'Chevron Left', iconName: 'ChevronLeft', category: 'Status', color: 'var(--text-faint)' },
    { name: 'Chevron Right', iconName: 'ChevronRight', category: 'Status', color: 'var(--text-faint)' },
    { name: 'Plus', iconName: 'Plus', category: 'Status', color: 'var(--text-faint)' },
    { name: 'Plus Circle', iconName: 'PlusCircle', category: 'Status', color: 'var(--text-faint)' },
    { name: 'Minus', iconName: 'Minus', category: 'Status', color: 'var(--text-faint)' },
    { name: 'Minus Circle', iconName: 'MinusCircle', category: 'Status', color: 'var(--text-faint)' },
    { name: 'Maximize', iconName: 'Maximize', category: 'Status', color: 'var(--text-faint)' },
    { name: 'Minimize', iconName: 'Minimize', category: 'Status', color: 'var(--text-faint)' },
    { name: 'Zoom In', iconName: 'ZoomIn', category: 'Status', color: 'var(--text-faint)' },
    { name: 'Zoom Out', iconName: 'ZoomOut', category: 'Status', color: 'var(--text-faint)' },
